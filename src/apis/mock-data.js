export const mockData = {
  board: {
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover: 'https://icdn.dantri.com.vn/k:a6f7e4a5db/2016/01/09/natural-1-1452281304567/bo-suu-tap-hinh-nen-phong-canh-tuyet-dep-danh-cho-nguoi-yeu-thien-nhien.jpg',
      ...
      /* Xử lý bug khi column là rỗng
        - Phía FE sẽ tạo ra 1 card đặc biệt FE_Placeholder Card, không liên quan tới BE
        - Card này sẽ được ẩn ở giao diện người dùng
        - Cấu trúc id của card này để Unique, nó k bị trùng với id của những cái card mặc định được tạo ra
        -> 'columnId-placeholder-card', mỗi column chỉ có thể có tối đa 1 Placeholder Card
        - Khi tạo 1 placeholder-card phải đầy đủ: _id, boardId, columnId, FE_PlaceholderCard
      */
      {
        _id: 'column-id-04',
        boardId: 'board-id-01',
